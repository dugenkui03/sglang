...
![图1：全注意力(Full Attention)、稀疏注意力(Sparse Attention)及对应矩阵](../user_guide_zh_assets/hisparse-01-dense-vs-sparse-4x3.png)
...
![图2：轻量索引打分、Top-k 选择与主要注意力计算](../user_guide_zh_assets/hisparse-02-dsa-selection-4x3.png)
...
![图3：CPU 完整 KV、GPU 热点副本、缓存命中与按需换入](../user_guide_zh_assets/hisparse-03-cpu-gpu-kv-4x3.png)
...
插图由 imagegen 生成；[三张图的提示词](../user_guide_zh_assets/hisparse-images.prompt.txt)记录统一示例与绘制要求。概念背景见 [2.1 注意力机制与注意力后端(Attention Mechanisms and Backends)](<2.1 注意力机制与注意力后端(Attention Mechanisms and Backends).md>)。
